...
-- You can go to client line 374 and edit it yourself.
Businesses.OriginalESX = true -- true = To use esx_billing, false to use okokBilling
Businesses.ResturantBillingEventESX = "esx_billing:sendBill"
...
Businesses.Businesses = {
    police = { -- Restaurant name, better to give it same name as job, must be same nam in config_warehouse.lua
        ...
        bossModel = "s_m_m_bouncer_01", -- NPC boss interaction
        bossCoords = vec4(-570.692, 277.961, 77.676, 268.556),

        clockin = {
            coords = vector4(-574.6028, 293.2412, 79.0848, 170.42), -- Taking service
            dimensions = { width = 1.5, length = 0.6, height = 0.6 } -- Dimensions for clockin area
        },

        registers = { -- Place to send bills to customers
        ...
        trays = { -- place to give items to customers
        ...
        storage = { -- Where you'll find delivered goods
            {
        ...
        CookLoco = { -- place to prepare drinks/foods
            {
                ...
                items = {
                    {
                        item = "water", -- item to recived
                        amount = 1, -- how much you recieved
                        time = 8000, -- Time to prepare the item in milliseconds
                        progressLabel = "Preparing Water",
                        requiredItems = {
                            { item = "water", amount = 1 } -- item required to prepare
                        },
                        icon = "fas fa-water"
                    },
        ...
        chairs = {
            ...
            { coords = vector4(-573.61, 285.68, 79.23, 0.53) },
            { coords = vector4(-572.44, 285.58, 79.23, 349.48) },
            { coords = vector4(-570.83, 290.47, 79.23, 79.16) },
