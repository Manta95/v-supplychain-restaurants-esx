...
Config.Restaurants = {
    [1] = {
        name = "Tequi-la-la",
        job = "police",
        position = vector3(-575.4901, 289.0903, 78.9936), -- Position to place a command (better put in Boss Office
        delivery = vector3(-558.17, 301.81, 83.58), -- parking to go with truck
        deliveryFoot = vector3(-561.87, 294.19, 86.49), -- Place to deliver boxes while on foot
        heading = 90.0,
        playerMoney = false,  -- true = pay order with cash / false = pay order with society money
        allowallplayer = false -- true : all players can driver trucks at warehouse to deliver goods, false : only player with job can deliver goods
    },
    -- add more here
}
--#################################
...
Config.Clothing = {
    ...
    OwnIcon = "fa fa-box",
    OwnDescription = "Mettre sa tenue civil",
    OwnLabel = "Vetement civil",
	
    EmployerIcon = "fa fa-box",
    EmployerDescription = "Mettre sa tenue de travail",
    EmployerLabel = "Vetement employé",
}
...
Config.Items = {
    ["police"] = {  -- Restaurant name, better to give it same name as job, must be same nam in config_restaurant.lua
...
Config.ItemsFarming = {
    ['bread'] = {label = 'Pain', price = 4},
    ["beer"] = {label = "Biere", price = 10},
